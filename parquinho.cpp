...
int raca[5] = {human, elf, dwarf, alacryan, arcont};
string raca_texto[5] = {
    "Humano",
    "Elfo",
    "Anão",
...
int main()
{
  ...
  // Atributos base de Arconte
  Características arconte;
  arconte.nome = "Arconte";
  arconte.atk = 10;
  arconte.def = 7;
  arconte.mp = 0;
  arconte.hp = 9;
  ...
  cout << "Escolha a raça do seu personagem\n (0 -> Humano / 1 -> Elfo / 2 -> Anao / 3 -> Alacryano / 4 -> Arconte)\n";
  cin >> raca_escolhida;
  while (raca_escolhida < 0 || raca_escolhida > 4)
  {
  ...
  case arcont:
    cout << "Voce escolheu a raca Arconte\n";
    break;
  ...
  while (pontos > 0)
  {
    ...
    case atk:
      ...
      else if (raca_escolhida == arcont)
      {
        arconte.atk += 1;
        pontos -= 1;
        cout << "Ataque base aumentado para " << arconte.atk << endl;
      }
      break;
    ...
    case def:
      ...
      else if (raca_escolhida == arcont)
      {
        arconte.def += 1;
        pontos -= 1;
        cout << "Defesa base aumentado para " << arconte.def << endl;
        break;
      ...
      case mp:
        ...
        else if (raca_escolhida == arcont)
        {
          arconte.mp += 1;
          pontos -= 1;
          cout << "Mana base aumentado para " << arconte.mp << endl;
        }
        break;
      ...
      case hp:
        ...
        else if (raca_escolhida == arcont)
        {
          arconte.hp += 1;
          pontos -= 1;
          cout << "Vida base aumentado para " << arconte.hp << endl;
        }
        break;
      ...
      case inte:
        ...
        else if (raca_escolhida == arcont)
        {
          arconte.inte += 1;
          pontos -= 1;
          cout << "Inteligencia base aumentado para " << arconte.inte << endl;
        }
        break;
      }
    }
      // Resultado do personagem + atributos finais
      ...
      if (raca_escolhida == human)
      {
        ...
        cout << "Aether: " << humano.at + classe_modificadores[classe_escolhida][5] + subclasse_modificadores[subclasse_escolhida][5] << endl;
      }
      else if (raca_escolhida == elf)
      {
        ...
        cout << "Aether: " << elfo.at + classe_modificadores[classe_escolhida][5] + subclasse_modificadores[subclasse_escolhida][5] << endl;
      }
      else if (raca_escolhida == dwarf)
      {
        ...
        cout << "Aether: " << anao.at + classe_modificadores[classe_escolhida][5] + subclasse_modificadores[subclasse_escolhida][5] << endl;
      }
      else if (raca_escolhida == alacryan)
      {
        ...
        cout << "Aether: " << alacryano.at + classe_modificadores[classe_escolhida][5] + subclasse_modificadores[subclasse_escolhida][5] << endl;
      }
      else if (raca_escolhida == arcont)
      {
        cout << "Ataque: " << arconte.atk + classe_modificadores[classe_escolhida][0] + subclasse_modificadores[subclasse_escolhida][0] << endl;
        cout << "Defesa: " << arconte.def + classe_modificadores[classe_escolhida][1] + subclasse_modificadores[subclasse_escolhida][1] << endl;
        cout << "Mana: " << arconte.mp + classe_modificadores[classe_escolhida][2] + subclasse_modificadores[subclasse_escolhida][2] << endl;
        cout << "Vida: " << arconte.hp + classe_modificadores[classe_escolhida][3] + subclasse_modificadores[subclasse_escolhida][3] << endl;
        cout << "Inteligência: " << arconte.inte + classe_modificadores[classe_escolhida][4] + subclasse_modificadores[subclasse_escolhida][4] << endl;
        cout << "Aether: " << arconte.at + classe_modificadores[classe_escolhida][5] + subclasse_modificadores[subclasse_escolhida][5] << endl;
      }
    }
   return 0; 
  }